/*! ehc-gr20 v0.1.0 - (c) 2018 erik.hagreis@gmail.com */
...
(function (root, factory) {
            ...
            parent: function (type) {
                ...
                while (parent && parent.node instanceof window.SVGElement) {
                    if (typeof type === 'string' ? parent.matches(type) : parent instanceof type)
                        return parent;
                    if (parent.node.parentNode.nodeName == '#document')
                        return null; // #720
                    parent = SVG.adopt(parent.node.parentNode);
                }
            }
    ...
    SVG.FX = SVG.invent({
        ...
        extend: {
            ...
            ,
            after: function (fn) {
                var c = this.last(), wrapper = function wrapper(e) {
            ...
            step: function (ignoreTime) {
                ...
                if (this.active)
                    this.target().fire('during', { pos: this.pos, eased: eased, fx: this, situation: this.situation });
    ...
    SVG.on = function (node, event, listener, binding, options) {
        ...
        var l = listener.bind(binding || node.instance || node), index = (SVG.handlerMap.indexOf(node) + 1 || SVG.handlerMap.push(node)) - 1, ev = event.split('.')[0], ns = event.split('.')[1] || '*';
        // ensure valid object
    ...
    SVG.off = function (node, event, listener) {
        var index = SVG.handlerMap.indexOf(node), ev = event && event.split('.')[0], ns = event && event.split('.')[1], namespace = '';
        if (index == -1)
            return;
        if (listener) {
    ...
    SVG.extend(SVG.Element, {
        ...
        ,
        forward: function () {
            var i = this.position() + 1, p = this.parent();
...
Object.defineProperty(exports, "__esModule", { value: true });
var svg_js_1 = __importDefault(__webpack_require__(/*! svg.js */ "./node_modules/svg.js/dist/svg.js"));
var onDocumentReady_1 = __importDefault(__webpack_require__(/*! ./utils/onDocumentReady */ "./src/utils/onDocumentReady.ts"));
console.log('document', document.readyState);
onDocumentReady_1.default(function () {
    var route = svg_js_1.default('route').size(600, 600);
    var rect = route.rect(100, 100).attr({ fill: '#f06' });
    console.log('DOMContentLoaded', route, rect);
});
...
Object.defineProperty(exports, "__esModule", { value: true });
function onDocumentReady(action) {
    if (document.readyState !== 'loading') {
        document.addEventListener('onDOMContentLoaded', function (event) {
            action();
        }, false);
    }
    action();
...
/***/ 0:
/*!**********************************************!*\
  !*** multi ./src/polyfills.ts ./src/main.ts ***!
  \**********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! ./src/polyfills.ts */"./src/polyfills.ts");
